...
Notes:
    ...
    cd ~/code/progiter/docs
    sphinx-apidoc --private --separate --force --output-dir ~/code/progiter/docs/source/auto ~/code/progiter/progiter
    ...
    Also:
        ...
        Enter the following information:
            Set the Repository NAME: progiter
            Set the Repository URL: https://github.com/Erotemic/progiter

        Make sure you have a .readthedocs.yml file

        For gitlab you also need to setup an integrations. Navigate to:

            https://readthedocs.org/dashboard/progiter/integrations/create/
        ...
        Then go to
            ...
            https://github.com/Erotemic/progiter/hooks
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/progiter/versions/
"""
#
...
mod_dpath = join(repo_dpath, 'progiter')
...
# html_logo = '.static/progiter.svg'
# html_favicon = '.static/progiter.ico'
...
latex_documents = [
    (master_doc, 'progiter.tex', 'progiter Documentation',
     'Jon Crall', 'manual'),
]
...
man_pages = [
    (master_doc, 'progiter', 'progiter Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'progiter', 'progiter Documentation',
     author, 'progiter', 'One line description of project.',
     'Miscellaneous'),
]
